        ...
        return (
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground">
              Liegt der Abholort in einer <strong className="text-foreground">günstigeren Tarifzone</strong> als Ihr Wohnort, werden die Kosten der günstigeren Zone zugrunde gelegt.
            </p>
